...
- 共有の MySQL データベース（すべてのアプリケーションノードが同じデータベースにアクセスする必要があります）
...
まず、すべてのアプリケーションノードからアクセスできる MySQL データベースを準備します。次のような構成を利用できます：

- 個別にデプロイした高可用性 MySQL サービス
- クラウドプロバイダーが提供するマネージドデータベースサービス
- 独立したサーバーで実行する MySQL
