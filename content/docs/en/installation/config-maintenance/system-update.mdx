...
This document provides methods and best practices for updating the Ace Hub system to ensure a smooth upgrade to the latest version.
...
If you have deployed Ace Hub using a single Docker container, you can update by following these steps:
...
2.  Find the Ace Hub application and click the **Upgrade** button
...
2.  Find the Ace Hub container, click **More** -> **Recreate**
...
If you have deployed Ace Hub by compiling from source code, the update steps are as follows:
