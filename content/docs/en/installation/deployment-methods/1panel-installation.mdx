...
This document provides a graphical tutorial for deploying Ace Hub using the 1Panel panel.
...
## Step 2: Install Ace Hub

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the Ace Hub application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure Ace Hub application parameters on the installation page:
</Callout>

- **Name**: The name of the Ace Hub application to be created
- **Version**: Select the version of Ace Hub
- **Port**: The service port for the Ace Hub application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the Ace Hub application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the Ace Hub application
...
## Step 4: Access Ace Hub

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the Ace Hub WebUI page
...
2. Find the Ace Hub application, click the **Upgrade** button
