...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to Ace Hub for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Ace Hub console, you can add
...
### Import Configuration from Ace Hub Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Ace Hub console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Ace Hub configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | AceHub                                  |
| Access Token        | AceHub Key                              |
| AceHub Endpoint     | AceHub Deployment Address (without /v1) |
