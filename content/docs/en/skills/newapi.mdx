---
title: newapi
description: newapi is the official Ace Hub user-level Skill for Claude Code, Codex, and OpenClaw. Query models, manage tokens, view groups, check balance, and ask Ace Hub usage questions directly inside your AI coding workflow.
---
...
<Callout type="info" title="What is newapi-skills?">
  **newapi-skills** is the official AI editor Skill plugin from Ace Hub. Skills are a lightweight extension protocol that enables AI coding assistants — such as Claude Code, Codex, OpenClaw, Cursor, Windsurf, and Cline — to **call Ace Hub endpoints directly from within the editor**, performing model queries, token management, balance checks, and answering Ace Hub deployment, configuration, and API usage questions without ever leaving your coding environment.

  - GitHub Repository: [github.com/QuantumNous/skills](https://github.com/QuantumNous/skills)

  It now also works inside OpenClaw, so you can run `/newapi` commands for models, tokens, groups, and balance, and ask Ace Hub usage questions without leaving your agent workflow.
</Callout>

## Why Use Skills

During everyday AI development, developers frequently switch between their editor and the Ace Hub management dashboard — checking available models, creating API tokens, inspecting balance, adjusting group quotas. These context switches disrupt coding flow.
...
- **Built-in help**: Ask about Ace Hub deployment, configuration, groups, and API call formats directly from your coding workflow
...
Below is the complete list of commands provided by newapi-skills. These commands interact with the Ace Hub REST API to query and manage resources on your Ace Hub instance.

### Query Commands

| Command | Description | Use Case |
|---------|-------------|----------|
| `/newapi models` | List available AI models | View all models configured on your Ace Hub instance (OpenAI, Claude, Gemini, etc.) |
...
| Command | Description | Use Case |
|---------|-------------|----------|
| `/newapi help <question>` | Ask about Ace Hub | Get help on Ace Hub deployment, configuration, API call formats, and more |
...
<Steps>
  ...
  <Step>
    ...
    newapi-skills requires three environment variables to connect to your Ace Hub instance. Add them to your shell profile:
    ...
    |----------|-------------|---------|
    | `NEWAPI_BASE_URL` | Ace Hub service URL | `https://api.example.com` |
  ...
  <Step>
    ...
    - Type `/newapi help how do I configure groups and tokens?` to ask Ace Hub usage questions directly
...
- GitHub Repository: [github.com/QuantumNous/skills](https://github.com/QuantumNous/skills)
- Ace Hub Website: [www.newapi.ai](https://www.newapi.ai)
- Ace Hub GitHub: [github.com/QuantumNous/new-api](https://github.com/QuantumNous/new-api)
